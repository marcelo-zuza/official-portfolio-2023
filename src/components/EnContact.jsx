            ...
            <div className="px-10 py-14 mx-0 md:m-20 md:px-6 md:py-14rounded-xl ">
                <div className="text-4xl bg-green-200 text-black border rounded-2xl px-6 py-12">
                  ...
                  <form onSubmit={handleSubmit}>
                      ...
                      {isSuccess && <p style={{ color: 'green', fontSize: '26px' }}>Your e-mail has been sent!</p>}
                      <div className="flex justify-center pt-4">
                        <button className="bg-green-500 text-white text-2xl px-8 py-4 rounded-full hover:bg-white hover:text-green-500 duration-700 hover:px-14" type="submit">Send</button>
                      </div>
                </form>
                </div>
