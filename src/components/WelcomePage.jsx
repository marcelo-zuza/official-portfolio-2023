...
const WelcomePage = () => {
  return (
    <div>
        <div className="bg-black w-full h-full pt-10 pb-48 px-2 md:pb-24 md:py-16 font-BebasNeue tracking-widest">
            <div className="p-4 justify-center -mb-3 md:mb-0">
                ...
                <div className="flex justify-center pt-4">
                    <img src={Icone} alt="icone" className="w-40 md:w-32" />
                </div>
            </div>
            <div className="flex flex-1 justify-center md:grid grid-cols-2 md:px-12 border-white rounded-full md:border-none">
                <div className="px-4 md:col-span-1 my-5 md:p-0 md:m-0 md:border-white rounded-full">
                    <p className="text-white text-center text-3xl md:text-6xl mb-5 font-extrabold">WELCOME!</p>
                ...
                <div className="px-4 md:px-4 col-span-1 my-5 md:py-0 md:m-0 md:border-white rounded-full">
                    <p className="text-white text-center text-3xl md:text-6xl mb-5 font-extrabold">BEM-VINDO!</p>
                    <div className="flex justify-center -m-2">
