        ...
        <div className="bg-black w-full h-full py-16 px-2 md:pb-24 font-BebasNeue tracking-widest">
            ...
            <div className="grid md:grid-cols-2 px-12 border-white rounded-full md:border-none">
                ...
                <div className="col-span-1 my-5 md:py-0 md:m-0 md: border-white rounded-full">
                    ...
                    <div className="flex justify-center -m-2">
                    <a href="/official-portfolio-2023/pt" className="bg-green-500 text-white text-2xl px-6 py-4 md:px-10 rounded-full hover:bg-white hover:text-green-500 duration-700 hover:px-14">PORTUGUÊS</a>
                    </div>
                </div>
            </div>
