...
const EnHero = () => {
  return (
    <div>
        <div className="bg-black w-full h-full pt-10 pb-28 px-2 md:p-18 md:py-16 font-BebasNeue tracking-widest">
            <div className="p-4 justify-center mb-2 md:mb-0">
                ...
                <div className="flex justify-center py-2 pb-20">
                    <a href="/en/#about" className="bg-green-500 text-white text-3xl px-8 py-4 rounded-full hover:bg-white hover:text-green-500 duration-700 hover:px-14">Start Here</a>
                </div>
            </div>
          </div>  
    </div>
